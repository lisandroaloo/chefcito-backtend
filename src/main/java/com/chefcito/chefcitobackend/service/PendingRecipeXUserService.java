...
public class PendingRecipeXUserService {
  ...
  public ResponsePendingRecipeXUserDto addPendingRecipeXUser(RequestPendingRecipeXUserDto pendingRecipeXUserDto) {
    PendingRecipeXUser parsedPendingRecipeXUser = RequestPendingRecipeXUserDto.toPendingRecipeXUser(pendingRecipeXUserDto);
  ...
  public ResponsePendingRecipeXUserDto updatePendingRecipeXUser(Long id, RequestPendingRecipeXUserDto pendingRecipeXUserDto) {
